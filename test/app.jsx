...
print(f"Fetch from GitHub: {FETCH_FROM_GITHUB}")
if FETCH_FROM_GITHUB:
    print(f"GitHub Repo: {GITHUB_REPO_OWNER}/{GITHUB_REPO_NAME}")
    print(f"GitHub File: {GITHUB_FILE_PATH} (branch: {GITHUB_BRANCH})")


GITHUB_EXCEL_REPO = f"{GITHUB_REPO_OWNER}/{GITHUB_REPO_NAME}" if FETCH_FROM_GITHUB else None
GITHUB_EXCEL_PATH = GITHUB_FILE_PATH if FETCH_FROM_GITHUB else None
GITHUB_EXCEL_BRANCH = GITHUB_BRANCH if FETCH_FROM_GITHUB else 'main'
GITHUB_EXCEL_TOKEN = os.environ.get('GITHUB_TOKEN', None)
EXCEL_CACHE_TIMEOUT = int(os.environ.get('EXCEL_CACHE_TIMEOUT', '300'))
